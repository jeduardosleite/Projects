...
def main():
    ...
    st.sidebar.markdown(
        ...
        Este projeto tem a supervisão do Breno , cientista de dados da Unimed.
    ...
    age = st.sidebar.number_input("Idade", min_value=0, max_value=120, value=30, help="Informe a idade do paciente em anos.")
    ...
    children = st.sidebar.number_input("Número de filhos", min_value=0, max_value=10, value=0, help="Número de dependentes filhos do paciente.")
